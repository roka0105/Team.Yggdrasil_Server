...
void CLoginMgr::JoinProc(CSession* _ptr)
{
	...
	case SUBPROTOCOL::JoinInfo:
		...
		unsigned long protocol = 0;
		CProtocolMgr::GetInst()->AddMainProtocol(&protocol, (unsigned long)MAINPROTOCOL::JOIN);
...
void CLoginMgr::LogOutProc(CSession* _ptr)
{
	...
	case SUBPROTOCOL::LogoutInfo:
		...
		unsigned long protocol = 0;
		CProtocolMgr::GetInst()->AddMainProtocol(&protocol, (unsigned long)MAINPROTOCOL::LOGOUT);
...
void CLoginMgr::EnterLobbyProc(CSession* _ptr)
{
	...
	case SUBPROTOCOL::LobbyEnter:
		...
		CProtocolMgr::GetInst()->AddSubProtocol(&protocol, (unsigned long)SUBPROTOCOL::LobbyResult);
